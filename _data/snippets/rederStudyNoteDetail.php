...
if (!$posterUrl) return 'Missing cover image.';
...
$ext = strtolower(pathinfo($posterUrl, PATHINFO_EXTENSION));
...
$placeholders = array_merge($data, [
    ...
    'pdfFile2' => $data['pdf_file2']['data']['attributes']['url'],
